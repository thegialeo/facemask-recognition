...
def evaluate_acc(model, loader, device, mtcnn=None):
    """
...
def train(model, trainloader, testloader, criterion, optimizer, scheduler, num_epochs, device, mode, detection, mtcnn):
    """
